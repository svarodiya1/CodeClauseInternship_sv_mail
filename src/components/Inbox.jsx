...
const Inbox = () => {
    ...
    return (
        <div className='flex-1 bg-[#EDE8F5] rounded-xl mx-8'>
                ...
                <div className='flex items-center gap-1'>
                    {
                        mailType.map((item, index) =>
                            <button
                                key={index}
                                className={`flex items-center gap-5 p-4 ${mailTypeSelected === index ? 'border-b-4 border-b-blue-600 text-blue-600' : 'border-b-4 border-b-transparent'} w-52 hover:bg-[#ADBBDA]`}
                                onClick={() => {
